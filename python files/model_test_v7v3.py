...
modelholder = ['/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/trainNB/best output/NB_modelv3v1.sav', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/trainKNN/best output/KNN_modelv3v1.model', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/trainDT/best output/DT_modelv3v1.model', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/trainRF/best outputs/RF_modelv3v1.model', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/v7/lightgbm_modelv7v9.model','/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/trainXGBoost/best outputs/xgboost_modelv3v1.model']

for x in range(0, len(modelholder)):

    #Check the model to load
    if x == 4:
        loaded_model = lgb.Booster(model_file=modelholder[x])
    elif x == 5:
        loaded_model = xgb.Booster(model_file=modelholder[x])
    else:
        loaded_model = joblib.load(modelholder[x])
    ...
    for urli in urls:
        ...
        if(requestFailed == False):
            ...
            with open('/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/externalTraining/'+ str(x) + 'predictions.csv', 'a', encoding='utf-8') as f:
                if urli[1] <= 0.99:
                    if prediction <= 0.99:
    ...
    #Save the accuracy, precision, recall and f1 score to a txt file
    with open('/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/externalTraining/'+ str(x) +'.txt', 'a') as f:
    ...
    #print the confusion matrix visually using seaborn
    sns.heatmap(cm, annot=True, cmap='Blues')
    plt.xlabel('Predicted')
    plt.ylabel('True')
    #plt.show()

    plt.savefig('/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3/externalTraining/'+ str(x) + '.png')
