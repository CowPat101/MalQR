...
#URL extraction
    ...
    try:
        ...
        # Pad the feature vector to the desired size (5000)
    ...
    #Loop and print out all of the rates
...
df = pd.read_csv('/Users/jackcavar/Documents/University work/Dissertation/Jack_Cavar_2000314_Artefact_Files/urldata.csv')
...
if os.path.exists('/Users/jackcavar/Documents/University work/Dissertation/Jack_Cavar_2000314_Artefact_Files/predictions.csv'):
    os.remove('/Users/jackcavar/Documents/University work/Dissertation/Jack_Cavar_2000314_Artefact_Files/predictions.csv')

#Add the column headers, benign, malicious, actual to the csv file
with open('/Users/jackcavar/Documents/University work/Dissertation/Jack_Cavar_2000314_Artefact_Files/predictions.csv', 'a') as f:
...
loaded_model = lgb.Booster(model_file='/Users/jackcavar/Documents/University work/Dissertation/Jack_Cavar_2000314_Artefact_Files/python files/train_method_one/trainLight/lightgbm_modelv3v9.model')


#Load the tflite model
import tensorflow as tf

interpreter = tf.lite.Interpreter(model_path="/Users/jackcavar/Documents/University work/Dissertation/Jack_Cavar_2000314_Artefact_Files/modelv9_float16.tflite")
...
for urli in urls[:1]:
    ...
    #print out the first 254 values of the feature vector
    for i in range(5254):
        print("Feature vector value " +str(i)+": ", feature_vector[i], "\n")
    ...
    #print out the entire feature array
    for i in range(0):
        print("Feature array: ", feature_array[0][i])
    ...
    if(requestFailed == False):
        ...
        y_true = [urli[1]]
        y_pred = [1 if prediction >= 0.99 else 0]
        ...
        # Output the metrics
        print('Accuracy sci:', accuracy)
        print('Precision sci:', precision)
        print('Recall sci:', recall)
        print('F1 score sci:', f1)
...
print("TFLite prediction: ", tflite_prediction)
