Jack Cavar - 2000314 - Project Artefact submission files and descriptions

To run any python file, please ensure that the correct file location has been selected within the program when loading files.
