...
modelholder = ['/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/NB/NB_modelv3v1.sav', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/KNN/KNNModel.model', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/DT/best outputs/DT_Modelv3v1.model', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/RF/RF_modelv3v1.model', '/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/light/lightgbm_modelv8v1.model','/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/xgboost/best output/xgboost_modelv3v1.model']
...
for x in range(0, len(modelholder)):
    ...
    for urli in urls:
        ...
        if(requestFailed == False):
            ...
            with open('/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/externalTraining/'+ str(x) + 'predictions.csv', 'a', encoding='utf-8') as f:
                if urli[1] <= 0.99:
                    if prediction <= 0.99:
    ...
    with open('/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/externalTraining/'+ str(x) +'.txt', 'a') as f:
    ...
    plt.savefig('/Users/jackcavar/Library/CloudStorage/OneDrive-AbertayUniversity/Dissertation/URL algorithm/training_v3v8/externalTraining/'+ str(x) + '.png')
